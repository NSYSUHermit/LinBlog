...
<img src="/post/2019-08-14-git-simple-tutorial_files/gi2.PNG" alt="gi2" width="100%" height="100%"/>

### Third: 
cd to your files location.(If you didn't know the DOS command,this web may be help:https://en.wikipedia.org/wiki/List_of_DOS_commands)  
![gi3](/post/2019-08-14-git-simple-tutorial_files/gi3.PNG)
...
```
KEY~ "git clone url" 
![gi4](/post/2019-08-14-git-simple-tutorial_files/gi4.PNG)
...
![gi5](/post/2019-08-14-git-simple-tutorial_files/gi5.PNG)