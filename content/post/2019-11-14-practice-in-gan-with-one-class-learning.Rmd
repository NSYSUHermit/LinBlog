---
title: Practice in GAN with One Class Learning
author: Hermit
date: '2019-11-14'
slug: practice-in-gan-with-one-class-learning
categories:
  - deep-learning
  - gan
  - machine-learning
...
![](/post/2019-11-14-practice-in-gan-with-one-class-learning_files/output_2_1.png)
![](/post/2019-11-14-practice-in-gan-with-one-class-learning_files/output_2_2.png)
...
```
    ...
    _________________________________________________________________
    reshape_1 (Reshape)          (None, 450, 1)            0         
    _________________________________________________________________
    conv1d_1 (Conv1D)            (None, 446, 450)          2700      
    _________________________________________________________________
    dropout_1 (Dropout)          (None, 446, 450)          0         
    _________________________________________________________________
    flatten_1 (Flatten)          (None, 200700)            0         
    _________________________________________________________________
    dense_3 (Dense)              (None, 450)               90315450  
    _________________________________________________________________
    dense_4 (Dense)              (None, 2)                 902       
    =================================================================
    ...
    _________________________________________________________________
    model_1 (Model)              (None, 450)               92650     
    _________________________________________________________________
    model_2 (Model)              (None, 2)                 90319052  
    =================================================================
...
![](/post/2019-11-14-practice-in-gan-with-one-class-learning_files/output_13_1.png)



![](/post/2019-11-14-practice-in-gan-with-one-class-learning_files/output_13_2.png)


![](/post/2019-11-14-practice-in-gan-with-one-class-learning_files/output_13_3.png)



![](/post/2019-11-14-practice-in-gan-with-one-class-learning_files/output_13_4.png)
