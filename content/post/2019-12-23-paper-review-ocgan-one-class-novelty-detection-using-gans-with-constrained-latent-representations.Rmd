...
tags:
  ...
  - neural network
---
這禮拜看完一篇有關生成對抗網路與One Class Learning 結合的論文(Source Link:https://arxiv.org/abs/1903.08550) ，其名稱為<<One-class Novelty Detection Using GANs with Constrained Latent Representations>>，因此主要方法與我目前在用的內容有很大的相關性。  
